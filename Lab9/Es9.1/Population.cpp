...
void Population::Mutation(int iInd, int whichmutation, int ncity,Random* rnd){
	...
	if(whichmutation==2) m_pop[iInd].Gen_Mut_2((int)(ncity*(rnd->Rannyu())),rnd,(int)((ncity/2-1)*(rnd->Rannyu())));
	if(whichmutation==3) m_pop[iInd].Gen_Mut_3((int)(ncity*(rnd->Rannyu())),(int)((ncity-1)*(rnd->Rannyu())));
}	
