...
//Read input informations
  ...
  ReadInput >> ngen;
  cout << "The generations (new populations) produced by tha algorithm are : " << ngen << endl;
...
// Generate the starting individual
   ...
   cout << "Il peso esponenziale nella selezione p = " << peso << endl;
   ...
   cout << "Third genetic mutation probability = " << prob_gen_mut3*100 << "%" << endl << endl;
...
//print the starting Population and his best individuals
   starting_population.PrintPop("Starting_Population.dat");
   if (circle_or_square==1) starting_population.PrintBest(0,"Best_Individual_Evolution_circle.dat",0);
   if (circle_or_square==0) starting_population.PrintBest(0,"Best_Individual_Evolution_square.dat",0);
   if (circle_or_square==1) starting_population.PrintHalfAverage("Average_Individuals_Evolution_circle.dat",nindividual,0);
   if (circle_or_square==0) starting_population.PrintHalfAverage("Average_Individuals_Evolution_square.dat",nindividual,0);
...
//Print the length of the best path
   if (circle_or_square==1) new_pop.PrintBest(0,"Best_Individual_Evolution_circle.dat",igen);
   if (circle_or_square==0) new_pop.PrintBest(0,"Best_Individual_Evolution_square.dat",igen);
...
//Print the averaged length value on the best half of the population
   if (circle_or_square==1) new_pop.PrintHalfAverage("Average_Individuals_Evolution_circle.dat",nindividual,igen);
   if (circle_or_square==0) new_pop.PrintHalfAverage("Average_Individuals_Evolution_square.dat",nindividual,igen);

//Print the best Path at the end of the simulation
   if(igen==ngen){
	if (circle_or_square==1) new_pop.Print_The_Best_Path(0,"Best_Individual_circle.dat");
	if (circle_or_square==0) new_pop.Print_The_Best_Path(0,"Best_Individual_square.dat");
   }
}
