...
//city randomly placed inside a square
	...
	if (node==0) cout << "The cities are randomly placed inside a square of side " << l << endl;
...
//..starting population
   if (node==0) starting_population.PrintPop("Starting_Population_square_0.dat");
   if (node==1) starting_population.PrintPop("Starting_Population_square_1.dat");
   if (node==2) starting_population.PrintPop("Starting_Population_square_2.dat");
   if (node==3) starting_population.PrintPop("Starting_Population_square_3.dat");
//...the length of the best path of starting population for each processor 
   if (node==0) starting_population.PrintBest(0,"Best_Individual_Evolution_square_0.dat",0);
   if (node==1) starting_population.PrintBest(0,"Best_Individual_Evolution_square_1.dat",0);
   if (node==2) starting_population.PrintBest(0,"Best_Individual_Evolution_square_2.dat",0);
   if (node==3) starting_population.PrintBest(0,"Best_Individual_Evolution_square_3.dat",0);
//...the averaged length value on the best half of the population for each processor 
   if (node==0) starting_population.PrintHalfAverage("Average_Individuals_Evolution_square_0.dat",nindividual,0);
   if (node==1) starting_population.PrintHalfAverage("Average_Individuals_Evolution_square_1.dat",nindividual,0);
   if (node==2) starting_population.PrintHalfAverage("Average_Individuals_Evolution_square_2.dat",nindividual,0);
   if (node==3) starting_population.PrintHalfAverage("Average_Individuals_Evolution_square_3.dat",nindividual,0);
...
//Print the length of the best path for each processor
   if (node==0) new_pop.PrintBest(0,"Best_Individual_Evolution_square_0.dat",igen);
   if (node==1) new_pop.PrintBest(0,"Best_Individual_Evolution_square_1.dat",igen);
   if (node==2) new_pop.PrintBest(0,"Best_Individual_Evolution_square_2.dat",igen);
   if (node==3) new_pop.PrintBest(0,"Best_Individual_Evolution_square_3.dat",igen);
...
//Print the averaged length value on the best half of the population
   if (node==0) new_pop.PrintHalfAverage("Average_Individuals_Evolution_square_0.dat",nindividual,igen);
   if (node==1) new_pop.PrintHalfAverage("Average_Individuals_Evolution_square_1.dat",nindividual,igen);
   if (node==2) new_pop.PrintHalfAverage("Average_Individuals_Evolution_square_2.dat",nindividual,igen);
   if (node==3) new_pop.PrintHalfAverage("Average_Individuals_Evolution_square_3.dat",nindividual,igen);

//Print the best Path at the end of the simulation
   if(igen==ngen){
	if (node==0) new_pop.Print_The_Best_Path(0,"Best_Individual_square_0.dat");
	if (node==1) new_pop.Print_The_Best_Path(0,"Best_Individual_square_1.dat");
	if (node==2) new_pop.Print_The_Best_Path(0,"Best_Individual_square_2.dat");
	if (node==3) new_pop.Print_The_Best_Path(0,"Best_Individual_square_3.dat");
   }
